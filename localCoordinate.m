function [object, transform_mat] = localCoordinate(ptCloud, inlier_indices, )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 6)LOCAL COORDINATE To form a local coordniate where the dominant plane 
% becomes the z=0 plane
%
